...
type Trade = { date: string; area: number; price: number; floor: number; dong?: string; aptDong?: string; buyerGbn?: string; slerGbn?: string; dealingGbn?: string; agentSgg?: string; rgstDate?: string; cdealType?: string; cdealDay?: string; presale?: boolean; };
